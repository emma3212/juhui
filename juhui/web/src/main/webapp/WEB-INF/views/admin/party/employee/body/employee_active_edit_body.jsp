    ...
    <div class="content">
        ...
        <div class="tab tab-horizon tab-red">
            ...
            <form data-fold="fold" class="box box-blue no-margin-box J_addForm" method="POST"
                  action="${website}admin/employee/${partyEmployeeDTO.partyId}/1">
                        ...
                        <div class="box-container">
                            <div class="box-body">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" onfocus="this.type='password'" class="w200 " data-valid-tip="8-15个字符或空，请输入密码|密码有误，请重新填写"
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" onfocus="this.type='password'" class="w200" data-valid-tip="8-15个字符或空，请再次输入密码|密码有误，请重新填写"
                ...
                <div class="form-footer form-footer-margin">
                    ...
                    <button type="button" class="btn btn-yellow btn-refresh"
                            onclick="window.location.href='${website}admin/employee/'+
                            <c:if test="${indexStatus == 1}">'active/list'</c:if>
                            <c:if test="${indexStatus == 2}">'inactive/list'</c:if>
                                    ">返回
                    </button>
                </div>
            </form>
