...
<form data-fold="fold" autocomplete="off" spellcheck="false" class="box box-blue no-margin-box J_addForm" action="${website}admin/member/edit/2" method="post">
                ...
                <div class="box-body">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <input type="text" class="w200 valid-icon <c:if test="${errCode eq 22007}">err</c:if>" data-valid-tip="1-25个字符，请输入公司全称|公司全称有误，请重新填写"
                                   data-valid-rule="length(0,26)" name="name" value="${memberDTO.name}"
                                    onload="document.all.TextBox1.focus()"/>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">
            ...
            <div class="box-container">
                <div class="box-body">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" data-valid-rule="isNull|length(0,21)" data-valid-tip="0-21个字符，请输入公司网站|公司网站有误，请重新填写" class="w200 valid-icon" name="website" value="${memberDTO.website}" />
                        </div>
                    </div>
                    <div class="control-group">
