    ...
    <div class="content">
        ...
        <div class="box box-blue" data-fold="fold">
            <div class="box-title clearfix">
                <span><i class="fa fa-table"></i>查看启用员工列表</span>
            </div>
                ...
                <div class="row-fluid control-group">
                    <div class="col span50">
                        <form class="J_searchForm">
                            ...
                            <input type="text" placeholder="关键字..." class="form-control search-input" name="key"/>
                    ...
                    <div class="col span50 ">
                        <div class="pull-right dropdown-container h30 clearfix">
                            ...
                            <ul class="dropdown-box" id="J_dropCnt">
                                <li><a href="${website}admin/employee/export/pdf/1" class="J_pdf"
                                       target="_blank">导出PDF</a></li>
                                <li><a href="${website}admin/employee/export/excel/1" class="J_excel" target="_blank">导出Excel</a>
                                </li>
                                <li><a class="J_abledTrigger" href="javascript:;">停用员工</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
