...
<div class="holder">
    <div class="content">
        ...
        <div class="box box-blue" data-fold="fold">
            <div class="box-title clearfix">
                <span><i class="fa fa-table"></i>查看已激活会员列表</span>
            </div>
            <div class="box-container clearfix">
                <div class="control-group">
                    <div class="pull-right dropdown-container h30 clearfix">
                        ...
                        <ul class="dropdown-box" id="J_dropCnt">
                            <li><a href="${website}admin/member/export/pdf/0?" class="J_pdf">导出PDF</a></li>
                            <li><a href="${website}admin/member/export/excel/0?" class="J_excel">导出Excel</a></li>
                            <li><a class="J_abledTrigger" href="javascript:;">停用会员</a></li>
                        </ul>
                    </div>
                </div>
                <div class="box-body">
                    <form class="J_operForm">
                        <table class="table-responsive">
                            ...
                            <tr>
                                ...
                                <th class="order pagination-reorder min-width" data-order-key="credit">积分</th>
                                <th class="order pagination-reorder table-width-8" data-order-key="recommender">推荐人</th>
                                <th class="order pagination-reorder table-width-8" data-order-key="manager">客户经理</th>
                                <th class="order pagination-reorder table-width-10" data-order-key="time">注册日期</th>
                                <th class="table-width-15">操作</th>
                            </tr>
                            </thead>
