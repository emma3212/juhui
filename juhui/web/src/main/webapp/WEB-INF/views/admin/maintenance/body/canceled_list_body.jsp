                ...
                <div class="control-group">
                    <div class="pull-right dropdown-container h30 clearfix">
                        ...
                        <ul class="dropdown-box" id="J_dropCnt">
                            ...
                            <li><a href="#" class="J_delOrder">删除订单</a></li>
                        </ul>
                    </div>
                </div>
                <div class="box-body">
                    <form class="J_operForm">
                        <table class="table-responsive">
                            ...
                            <tr>
                                ...
                                <th class="order pagination-reorder table-width-10" data-order-key="thruTime">取消时间
                                </th>
                                ...
                                <th class="order pagination-reorder table-width-7" data-order-key="applicant">申请人</th>
