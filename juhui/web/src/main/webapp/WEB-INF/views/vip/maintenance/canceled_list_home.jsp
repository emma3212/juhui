...
<tiles:insertDefinition name="vip">
    ...
    <tiles:putAttribute name="body" value="/WEB-INF/views/vip/maintenance/body/canceled_list_body.jsp" />
...
<script type="text/javascript">
    KISSY.ready(function(S){
        S.use('widget/calendar, widget/dropdown, page/freemaintainence/order-list',function(){
            PW.page.freemaintainence.orderList.Cancel({
                pagi: {
                    renderTo: '#J_pagination',
                    juicerRender: '#tpl',
                    dataRender: '#J_template',
                    pageSize: 10,
                    url: '${website}user/maintenance/order/canceled/ajax/list',
