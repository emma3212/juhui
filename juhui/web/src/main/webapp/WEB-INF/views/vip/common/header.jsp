...
<a class="logo" href="${website}home">
    <img src="${staticWebsite}img/admin/common/vip-logo2.png" alt="" height="86">
</a>
<div class="user-nav user-nav-margin">
    ...
    <ul id="J_userMenu" class="dropdown-info">
        <li>
            <a href="${website}user/member/edit"><i class="fa fa-key"></i>编辑会员档案</a>
            <a href="${website}logout"><i class="fa fa-key"></i>注销登录</a>
        </li>
    </ul>
</div>
<div class="dropdown-container manager">
    <a class="dropdown" id="J_managerInfo"  data-dropdown-box="J_managerMenu" data-dropdown-wait=".5">我的客户经理<i class="fa fa-caret-down press-right"></i></a>
    <ul id="J_managerMenu" class="dropdown-new-box">
        <li>
            <a class="manager-name" href="javascript:;">
                ${vip_manager.name}
            </a>
        </li>
        <li>
...
<div class="manager">
    <a href="${website}user/maintenance/apply">快速发起维护</a>
</div>
<div class="info">
