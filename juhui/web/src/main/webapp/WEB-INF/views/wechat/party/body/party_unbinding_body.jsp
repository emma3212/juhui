...
<div class="page container">
    <form class="J_validForm" autoComplete="off" action="${website}wechat/party/unbinding" method="post">
        ...
        <div class="row">
            ...
            <button type="submit" class="form-btn-submit middle bigger-font J_submit un-bind">解除绑定</button>
    </form>
</div>
